...
-- 3
insert into people (id, first_name, last_name, email, gender, age, language)
VALUES (51,'ernis','james','e@gmail.com','Male',24,'Kyrgyz');
-- 4
...
-- пол и год рождение всех мужчин родившихся после 2000 года
    select concat(first_name,' ' last_name) as full_name , gender,age from people where gender = 'Male' and age < 25;
...
-- 21. Найти самый распространенный язык среди женщин
 ...
 -- 22. Обновить язык для людей, чей возраст между 3 и 10 годами, на 'French'
     update people set language = 'French' where age between 14 and 24;
...
-- рождение с 1969 по 2005 год
  select first_name, last_name, age from people where (first_name ilike '%a%' or last_name ilike '%a%') and age between 20 and 56;
-- 32. Отобразите айди, имя, почту и возврст каждого человека и отсортируйте по возврасту в убывающем порядке
    select id, people.first_name, people.email, age from people order by age desc ;
